...
Microsoft has provided an official ML.Net 1.0 [Iris Classification](https://github.com/dotnet/machinelearning-samples/tree/master/samples/csharp/getting-started/MulticlassClassification_Iris "Multiclass Iris Classification") console application sample that provides more information on this problem.S
